...
A Monte Carlo simulation of t-butyl chloride ion pair separation in  water, written as a final project for the course *Molecular Modeling Methods* (CBE), Princeton University, October 2024.
...
- **Lennard-Jones + Coulombic potentials**
...
- **`interactionSite`** — an atom or interaction site with element type, relative position, and force field parameters (q, σ, ε)
